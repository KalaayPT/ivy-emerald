...
static const struct MenuAction MultichoiceList_DevonBalls[] =
{
    {COMPOUND_STRING("Ultra Ball")},
    {COMPOUND_STRING("Jet Ball")},
    {COMPOUND_STRING("Repeat Ball")},
};
...
static const struct MultichoiceListStruct sMultichoiceLists[] =
{
    ...
    [MULTI_DEVONBALLS]                 = MULTICHOICE(MultichoiceList_DevonBalls),
};
