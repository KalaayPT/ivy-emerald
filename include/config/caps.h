...
#define B_LEVEL_CAP_VARIABLE            69 // event variable used to derive level cap if B_LEVEL_CAP_TYPE is set to LEVEL_CAP_VARIABLE
...
#define B_EV_CAP_VARIABLE               252 // event variable used to derive EV cap if B_EV_CAP_TYPE is set to EV_CAP_VARIABLE
